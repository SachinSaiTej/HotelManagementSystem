...
public class AddCustomerController {
	...
	@GetMapping(value={"/receptionist/addCustomer","/admin/addCustomer","/customer/registration"})
	...
	@PostMapping(value={"/receptionist/addCustomer","/admin/addCustomer","/customer/registration"})
